            ...
            <div className='truck-pannel  sm:w-full md:w-[82%] flex-grow-[2]'>
                ...
                <div className='w-full flex items-center justify-between  bg-[#f5f6fa] h-16 p-2'>
                    ...
                    <div className=' h-20  w-2/4 flex items-center justify-center'>
                        <h1 className=' text-2xl font-poppins py-4  text-center font-medium' style={{ textShadow: '1px 1px #ccc' }}>Account Verify</h1>
                    </div>
                ...
                <div className=''>
                    <form className='w-full  h-18 p-4 flex  items-center justify-start' onSubmit={displayFetchedData} autoComplete='off'>
                        {/* <Outlinedfield handleChange={handleInput} labled='Account Number' /> */}
                        <TextField required={true} id="outlined-basic" label='Account Number' sx={{ marginTop: '8px' }} variant="outlined" onChange={(e) => { setValue(e.target.value) }} value={value} />
