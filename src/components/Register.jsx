                    ...
                    <div className='signup-form'>
                        ...
                        <form className='registration-form' id="registration-form" onSubmit={handleSubmit}>
                            ...
                            <div className="form-group form-button">
                                ...
                                <CustomButton type="submit" value="Submit" id="signup" marginLeft="0px" />
                                <NavLink to="/login" className="login-image-link text-blue-500 mt-2">I am Already Register</NavLink>
                            </div>
